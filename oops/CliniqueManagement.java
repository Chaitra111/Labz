		...
		do {
						...
						// Checking for availability of doctors
							...
							if (appoint.containsKey(newApp)) {
								...
								if (appointment <= 5) {
									...
									System.out.println("Appointment Scheduled on " + date.toString() + " "
											+ " with Doctor Id" + did);
								} else {
			...
			case 7:
				...
				do {
					...
					case 3:
						...
						ald = f.findByAvailability(ald, avail);
						System.out.println(ald);
						break;
					case 4:
						System.exit(0);
			...
			case 8:
				...
				do {
					...
					System.out.println();
					System.out.println("Enter your Choice: ");
					int ch3 =  Utility.getInteger();
					switch (ch3) {
					case 1:
						// Search Patients by id
						System.out.println("Enter Patients  Id");
						int pid1 = Utility.getInteger();
						alp = f1.findByPid(alp, pid1);
						System.out.println(alp);
						break;
					case 2:
						...
						alp = f1.findByPname(alp, pname1);
						System.out.println(alp);
						break;
					case 3:
						// Search Patients by Mobile Number
						System.out.println("Enter Patients Mobile Number");
						long num= Utility.getlong();
						alp = f1.findByPnumber(alp, num);
						System.out.println(alp);
						break;
					case 4:
						System.exit(0);
